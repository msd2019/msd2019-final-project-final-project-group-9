...
# Produce Network Visualizations and Preform Calculations for other Figures
```{r}
top15 <- data.frame()
rest <- data.frame()
...
for (dep in names(data_list)) {
  ...
  # Am doing rbing to keep data from all the departments, but adding the label of department first
