...
```{r read in data to sepearte categories (for fig 2)}

business_edglist <- read.table(
  file = here("data","original","Business_edgelist.txt"), 
                                header=T, sep="")
business_vertexlist <- read.table(
  file = here("data","original","Business_vertexlist.txt"), 
                                header=T, sep='\t')
computer_science_edglist <- read.table(
  file = here("data","original","ComputerScience_edgelist.txt"),
                                header=T, sep="")
computer_science_vertexlist <- read.table(
  file = here("data","original","ComputerScience_vertexlist.txt"), 
                                header=T, sep='\t')
history_edglist <- read.table(
  file = here("data","original","History_edgelist.txt"),
                                header=T, sep="")
history_vertexlist <- read.table(
  file = here("data","original","History_vertexlist.txt"), 
                                header=T, sep='\t')
